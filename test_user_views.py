...
# Before importing app, setup environment variable to use a different
# database for tests (need to do this before we import app, since that 
# will have already connected to the database)
...
# Create our tables (do this here, so we only create the tables once for
# all tests --- in each test, we'll delete the data and create fresh new 
# clean test data)

db.create_all()

# Don't have WTForms use CSRF at all, since it's hard to test
...
class MessageViewTestCase(TestCase):
    ...
    def test_remove_likes(self):
        ...
        #Now wea re sure that testuser likes the message "likable warble"
